...
/**
 * Interface to the native javascript object <code>SignaturePad</code> by
 ...
 * {@link SignatureField} component using the {@link JavaScript} annotation.
 * @author Max Schuster
 */
public class SignaturePad extends JavaScriptObject {
	...
	public interface BeginHandler {
		 ...
		 * Callback when stroke begin.
		 * 
		 * @param signaturePad SignaturePad instance
		 */
	 ...
	 * 
	 * @param beginHandler Callback when stroke begin
	 */
	 ...
	 * 
	 * @param endHandler Callback when stroke end.
	 */
