 ...
 * javascript object by <b>Szymon Nowak (szimek)</b> that can be found at
...
public class SignatureField extends AbstractField<String> {
	...
	/**
	 * A {@link Field} wrapping the SignaturePad
	 * javascript object by <b>Szymon Nowak (szimek)</b> that can be found 
         * at <a href="https://github.com/szimek/signature_pad">
         * https://github.com/szimek/signature_pad</a>
	 * 
	 * @author Max Schuster
	 */
