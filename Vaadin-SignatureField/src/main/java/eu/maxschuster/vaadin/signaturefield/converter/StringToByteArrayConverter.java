...
public class StringToByteArrayConverter implements Converter<String, byte[]> {
    ...
    /**
     * {@link DataUrlSerializer} used to extract the binary contents of the
     ...
     * {@link DataUrlSerializer} and {@link MimeType}.
     * 
     * @param serializer {@link DataUrlSerializer} used to extract the binary contents of the
     ...
     * {@code null}
     */
    public StringToByteArrayConverter(DataUrlSerializer serializer,
    ...
    /**
     * Creates a new {@link StringToByteArrayConverter} with the given 
     * {@link DataUrlSerializer} and automatic {@link MimeType} guessing.
     * 
     * @param serializer {@link DataUrlSerializer} used to extract the binary contents of the
     * RFC 2397 data url {@link String}. Must not be {@code null}!
